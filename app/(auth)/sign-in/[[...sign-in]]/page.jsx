...
export default function Page() {
  return (
    <section className="relative min-h-screen w-full bg-gray-900 text-white flex items-center justify-center">
      ...
      <img
        src="https://images.unsplash.com/photo-1519422640531-608486fed8fa?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        alt="Interview prep"
