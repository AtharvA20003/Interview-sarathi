    ...
    <div className=" bg-secondary shadow-sm ">
      <div className="w-[80%] m-auto flex gap-4 items-center justify-between">
        ...
        <ul className="hidden md:flex gap-6">
          <Link href="/dashboard">
            <li
              className={`hover:text-[#00aaff] hover:font-bold transition-all cursor-pointer ${
                path == "/dashboard" && "text-[#00aaff] font-bold"
              }`}
            >
              Dashboard
            </li>
          ...
          <li
            className={`hover:text-[#00aaff] hover:font-bold transition-all cursor-pointer ${
              path == "/dashboard/question" && "text-[#00aaff] font-bold"
            }`}
          >
            Questions
          </li>
          ...
          <Link href="/dashboard/howit">
            <li
              className={`hover:text-[#00aaff] hover:font-bold transition-all cursor-pointer ${
                path == "/dashboard/howit" && "text-[#00aaff] font-bold"
              }`}
            >
              How it works?
            </li>
